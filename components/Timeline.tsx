...
import { getExperience, getEducation, getCertifications } from '../src/utils/content';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {hasEducation ? EDUCATION.map((edu, index) => (
                        <motion.div
                            ...
                            transition={{ delay: index * 0.1 }}
                            className="p-6 border border-zinc-800 bg-zinc-900/20 rounded-2xl hover:bg-zinc-900/40 transition-colors"
                        >
