                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <a href="https://discord.com/users/1421252903242567731" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-4 rounded-xl bg-white/5 border border-white/5 hover:border-indigo-500/30 transition-all hover:bg-white/10">
