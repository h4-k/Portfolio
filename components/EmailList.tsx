    ...
    <section id="projects" className="py-32 relative">
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4 border-b border-zinc-800 pb-8">
            <div>
                ...
                <p className="text-zinc-400 max-w-md font-mono text-sm">
                    // DEPLOYED_SYSTEMS: {hasProjects ? PROJECTS.length : '00'}<br/>
                    // STATUS: {hasProjects ? 'OPERATIONAL' : 'STANDBY'}
                </p>
            </div>
        </div>
        ...
        {hasProjects ? (
                      ...
                      <div className="relative z-10 flex flex-col h-full transform transition-transform group-hover:translate-z-10" style={{ transformStyle: 'preserve-3d' }}>
                          <div className="flex justify-between items-start mb-6">
                              <div className="flex items-center gap-3">
                                  <div className={`p-3 rounded-xl border border-white/10 transition-all duration-300 group-hover:scale-110 shadow-lg ${
          ...
          <div className="bg-zinc-900/40 border border-dashed border-primary/30 rounded-2xl p-12 text-center">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              I’m currently curating real pentest case studies and creative builds. Subscribe to the contact feed below and you’ll be first to know when the drop goes live.
            </p>
          </div>
        )}
      </div>
