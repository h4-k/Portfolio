...
import { getArticles } from '../src/utils/content';
        ...
        <section id="articles" className="py-32 relative bg-zinc-950">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex items-center justify-between mb-16">
                    ...
                    <button className="hidden md:flex items-center gap-2 text-sm font-mono text-primary hover:text-white transition-colors">
                        VIEW_ARCHIVE <ArrowUpRight size={14} />
                    </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {ARTICLES.map((article, index) => (
                        <motion.article
                            ...
                            className="group flex flex-col h-full bg-zinc-900/30 border border-white/5 hover:border-primary/50 rounded-2xl p-6 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,220,130,0.1)] hover:-translate-y-1"
                        >
